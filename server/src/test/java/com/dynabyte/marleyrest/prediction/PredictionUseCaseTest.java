...
class PredictionUseCaseTest {
    ...
    void setUp() {
        ...
        try {
            ...
            file = ResourceUtils.getFile(ResourceUtils.CLASSPATH_URL_PREFIX + "google-tokens.json");
    ...
    void whenFaceIsRecognizedKnownPersonShouldBeReturned() {
        ...
        knownPerson.setGoogleTokens(googleTokens);
        ClientPredictionResponse expectedResponse = new ClientPredictionResponse(faceId, "Name", true, true, true);
        ...
        assertEquals(expectedResponse.hasAllowedCalendar(), response.hasAllowedCalendar());
    ...
    void whenUnknownFaceThenUnknownPersonShouldBeReturned(){
        ClientPredictionResponse expectedResponse = new ClientPredictionResponse(null, "Unknown", true, false, false);
    ...
    void whenFaceNotFoundThenIsFaceShouldBeFalse(){
        ClientPredictionResponse expectedResponse = new ClientPredictionResponse(null, "Unknown", false, false, false);
