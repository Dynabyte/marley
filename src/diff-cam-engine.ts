...
import { ICapturePayload, ICoordinates, IDiffCamEngine, IDiffCamEngineOptions, IMotionBox } from "./models/diffCamEngine.models";
...
export const DiffCamEngine: () => IDiffCamEngine = () => {
  ...
  let captureInterval: NodeJS.Timeout; // interval for continuous captures
